...
FREE_TIER_MODE = _get_bool_env("FREE_TIER_MODE", False)
...
ENABLE_LOCAL_RUN_HISTORY = _get_bool_env("ENABLE_LOCAL_RUN_HISTORY", not FREE_TIER_MODE)
RUN_HISTORY_REMOTE_BACKEND = (_get_env("RUN_HISTORY_REMOTE_BACKEND", "") or "").lower()
SUPABASE_URL = _get_env("SUPABASE_URL")
SUPABASE_SERVICE_ROLE_KEY = _get_env("SUPABASE_SERVICE_ROLE_KEY")
RUN_HISTORY_SUPABASE_TABLE = _get_env("RUN_HISTORY_SUPABASE_TABLE", "signalyze_run_history") or "signalyze_run_history"
...
ENABLE_FILE_ROLLBACK_SWITCH = _get_bool_env("ENABLE_FILE_ROLLBACK_SWITCH", not FREE_TIER_MODE)
ROLLBACK_SWITCH_ACTIVE = _get_bool_env("ROLLBACK_SWITCH_ACTIVE", False)
...
ENABLE_TRADE_TRACKING = _get_bool_env("ENABLE_TRADE_TRACKING", not FREE_TIER_MODE)
OPERATOR_API_KEY = _get_env("OPERATOR_API_KEY")
ENABLE_BACKGROUND_LOOP = _get_bool_env("ENABLE_BACKGROUND_LOOP", not FREE_TIER_MODE)
